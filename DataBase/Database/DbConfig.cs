...
namespace GMLogger.DataBase.Database
{
    ...
    /// </summary>
    public class DbConfig : IConnectionStringBuilder
    {
        ...
        public string BuildSQLiteConnectionString(IDbSettings settings)
        {
            ...
            System.Data.SQLite.SQLiteConnectionStringBuilder sqlBuilder = new System.Data.SQLite.SQLiteConnectionStringBuilder();
